﻿/* 仪器误差反演可视化模块 (instrument_calibrator) */

class InstrumentCalibratorView {
    constructor() {
        this.API_BASE = (() => {
    ...
    async fetchInstruments() {
        return this._json(`${this.API_BASE}/instruments`);
    }

    async fetchInstrument(id) {
        return this._json(`${this.API_BASE}/instruments/${id}`);
    }

    async fetchObservations(instrumentId) {
        return this._json(`${this.API_BASE}/instruments/${instrumentId}/observations`);
    }
    ...
    async invertErrors(instrumentId, refId = null, useGaia = true) {
        ...
        const solution = await this._json(
            `${this.API_BASE}/instruments/${instrumentId}/invert`,
            'POST',
            body
        );
...
const InstrumentAnalyzer = InstrumentCalibratorView;
window.InstrumentCalibratorView = InstrumentCalibratorView;
window.InstrumentAnalyzer = InstrumentAnalyzer;