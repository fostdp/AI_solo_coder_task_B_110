/* 亮度演化分析可视化模块 (variability_analyzer) */

class VariabilityAnalyzerView {
    constructor() {
        this.API_BASE = (() => {
...
const VariableStarAnalyzer = VariabilityAnalyzerView;
window.VariabilityAnalyzerView = VariabilityAnalyzerView;
